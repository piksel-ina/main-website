...
const HighlightedCard = ({ post }) => (
  <Link to={post.permalink} className={styles.newsArticles__highlightedCard}>
    <div className={styles.newsArticles__highlightedImageWrapper}>
      {post.image && (
        <img
          src={post.image}
          alt={post.title}
    ...
    <div className={styles.newsArticles__highlightedContent}>
...
const NewsArticles = () => {
  ...
  return (
    <section id="news" className={styles.newsArticles}>
      ...
      <div className={styles.newsArticles__footer}>
        <Button
          to="/blog"
          variant="outlined"
          color="#4a90e2"
