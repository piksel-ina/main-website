    ...
    <svg viewBox="0 0 480 340" preserveAspectRatio="xMidYMid meet">
      ...
      <g transform="translate(16 196)" opacity="0.9">
        ...
        <g transform="translate(0 8)">
          <text x="8" y="12" fontFamily={mono} fontSize="8" fill="#8e8e93">
            In [1]:
          </text>
          <rect
            x="46"
            ...
            stroke="#e5e5ea"
          />
          <text x="52" y="12" fontFamily={mono} fontSize="8" fill="#1040a8">
            import datacube, xarray as xr
          </text>
          <text x="52" y="23" fontFamily={mono} fontSize="8" fill="#1d1d1f">
            {'dc = datacube.Datacube(app="piksel")'}
          </text>
        </g>
        ...
        <g transform="translate(0 46)">
          ...
          <text x="52" y="34" fontFamily={mono} fontSize="8" fill="#1d1d1f">
