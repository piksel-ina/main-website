...
export default function UseCases() {
  ...
  if (!useCasesData || useCaseKeys.length === 0) return null;
    ...
    >
      ...
      <div className={styles.useCases__layout}>
        <div className={styles.useCases__navColumn}>
          <div
            className={styles.useCases__tabs}
            role="tablist"
            ...
            {useCaseKeys.map((key) => {
              ...
              return (
                <button
                  ...
                  className={clsx(
                    styles.useCases__tabButton,
                    isActive && styles['useCases__tabButton--active'],
                  )}
            ...
            {useCaseKeys.map((key) => {
              ...
              return (
                <div
                  ...
                  className={clsx(
                    styles.useCases__card,
                    isActive && styles['useCases__card--active'],
                  )}
                          ...
                          {item.features.map((feature, idx) => (
                            <div key={idx} className={styles.useCases__chip}>
                              <Check
                                size={14}
                                strokeWidth={2.5}
                                className={styles.useCases__chipIcon}
                              />
                              <span>{feature}</span>
                            </div>
                          ))}
