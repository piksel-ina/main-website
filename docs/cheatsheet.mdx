...
Selalu gunakan elemen `<figure>` dengan `<figcaption>` untuk memberikan konteks pada gambar.

<figure>

<img src="/img/preview/preview_sr.webp" alt="Contoh gambar dengan caption" style={{aspectRatio: '16/9', objectFit: 'cover', width: '100%'}} />

<figcaption>Tampilan citra satelit resolusi tinggi wilayah Jakarta — Sentinel-2, Band 4-3-2.</figcaption>
