---
sidebar_position: 5
title: Share, Save, and Tell a Map Story
...
## Share or save a map view

1. Configure the layers, styles, time, location, or comparison mode you want to share.
...
- select **Download map (png)** to save an image of the map view;
- select **Show Print View** to open a print-ready page;
- use **Embed map** to place the map view on a web page.
