...
<figure style={{textAlign: 'center'}}>
  ...
  <figcaption><strong>Analisis Garis Pantai </strong></figcaption>
</figure>

Workshop ini dilaksanakan dengan metode pembelajaran teknis berbasis praktik langsung (hands-on training) menggunakan platform Piksel. Kegiatan menghasilkan dua produk utama, yaitu citra GeoMAD Indonesia bebas awan dari Sentinel-2 serta data garis pantai multi-tahun berbasis Landsat. Hasil ini menjadi fondasi penting bagi pengembangan produk turunan lain, seperti peta penutup lahan dan analisis kebencanaan. Kedepan, kolaborasi akan terus diperkuat untuk menghasilkan inovasi pemetaan tematik yang mendukung pengelolaan wilayah dan sumber daya alam di Indonesia.
